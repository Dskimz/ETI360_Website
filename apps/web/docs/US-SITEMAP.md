...
Filled by Dan 2026-09-17; exported at 1600x900 JPG to `public/us/images/{slug}-hero.jpg` and `{slug}-2.jpg` (`us-index-hero.jpg`, `ohio-hero.jpg`, `ohio-2.jpg`). Re-export from the Canva design if a slot changes.
