...
const ROUTES: Array<{ path: string; priority: number; changeFrequency: "weekly" | "monthly" }> = [
  ...
  { path: "/duty-manager-simulation", priority: 0.7, changeFrequency: "monthly" },
  { path: "/perspective", priority: 0.4, changeFrequency: "monthly" },
  { path: "/perspective/emergency-documentation-for-educational-travel", priority: 0.4, changeFrequency: "monthly" },
