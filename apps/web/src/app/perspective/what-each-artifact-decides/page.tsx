...
const artifacts: Artifact[] = [
  ...
  {
    stage: "Stage 07 · Run · Place",
    docName: "Place Audit — Hospital Report",
    decision: "What medical capability exists at each location?",
    image: "/marketing/previews/place-audit.png",
    reader: "Duty manager · Trip leader · School medical officer",
    decides: [
      "Whether the primary hospital is adequate for the trip's risk profile",
      "What the default escalation is for serious cases",
      "Whether the local capability is licensed, English-proficient, and JCI-verified",
    ],
    body: [
      "A structured report per hospital covering role in the programme, ETA from default accommodation, systems ready (ICU, Major Trauma, Paeds, Surgery, Cardiology), medical tier, bed count, Trauma Level, Max ED wait, and Catchment Coverage. Limitations are stated explicitly — no hot outliers, no hidden assumptions.",
      "A Stage 07 trip leader is not qualified to assess a hospital in the first minutes of an incident. The Place Audit is the document that already did the assessment, calibrated to the trip, sitting in the trip leader's pocket before anything happens.",
    ],
  },
  {
