...
When done: `git add`, `git commit` on your branch, then `git push -u origin gtm-candidate-a`. Vercel will build a preview URL for the branch automatically.
...
- Do not visit or modify the other candidate's folder (/Users/danskimin/ETI360/documents/04 - ETI360 - Knowledge Base/GTM-Candidate-B).
